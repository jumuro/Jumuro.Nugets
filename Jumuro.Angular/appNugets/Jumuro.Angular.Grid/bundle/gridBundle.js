///#source 1 1 /appNugets/Jumuro.Angular.Grid/module.js
(function () {
    'use strict';
...
(function () {
    ...
    .directive('jumuroGrid', function () {
        var gridDirective = {
            restrict: "AE",
            scope: {
                gridOptions: "&jumuroGridoptions"
            },
            templateUrl: "appNugets/Jumuro.Angular.Grid/templates/gridTemplate.html?v=2",
            controller: jumuroGridCtrl
        }

        jumuroGridCtrl.$inject = ['$scope', '$filter'];

        return gridDirective;

        function jumuroGridCtrl($scope, $filter) {
